  ...
  return (
    <>
      <div className={`text-panel relative pb-6 pt-1 ${full ? 'w-full' : 'w-full lg:w-1/2'}`}>
        ...
        <p className='text-panel__body z-10'>Una comunidad de gente interesada en el desarrollo y diseño de productos digitales, donde compartir conocimientos, experiencias y consejos. Con la <strong>principal misión</strong> de mejorar la experiencia de aprendizaje y conocer mejor la realidad del mundo laboral.</p>
