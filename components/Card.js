...
export const Card = ({ title, emojiSrc }) => {
  return (
    <>
      <div className='card h-52 rounded-md border-black hover:border-ca-main-agora border-solid border-4 transition flex flex-col items-start relative p-4'>
      ...
      <style jsx>{`
        ...
        .card {
          box-shadow: -0.5rem 0.5rem 0 var(--light);
        }

        .card:hover {
          transform: translateY(-0.5rem);
          box-shadow: -0.75rem 1rem 0 var(--light);
        }
